/*
 * Copyright 2023 esanderson. All Rights Reserved.
 */
...
niagaraSigning {
  aliases.set(listOf("kitFloatingPoint"))
  signingProfileFile.set(project.layout.projectDirectory.file("signing/signing-profile.xml"))
}
